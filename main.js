...
gltfLoader.load('crt-draco.glb', (gltf) => {
...
penguinGroup.position.set(-4.5, -1.5, -27.0);
...
screenMesh.position.set(0, 0, -0.4);
screenMesh.scale.set(0.70, 0.80, 1);
...
crtOverlay.position.set(0, 0, 0.40);
crtOverlay.scale.set(0.70, 0.80, 1);
...
function updateDebug() {
  ...
  debugEl.textContent =
    ...
    `screen:  z=${s.z.toFixed(2)}  overlay: z=${o.z.toFixed(2)}\n` +
